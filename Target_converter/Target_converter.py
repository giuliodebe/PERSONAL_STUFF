...
class TargetConverterApp(QMainWindow):
    def __init__(self):
        ...
        # Left panel for input targets (now just a preview)
        left_panel = self.create_group_box("INPUT TARGETS PREVIEW")
        left_layout = QVBoxLayout()
        left_panel.setLayout(left_layout)
        
        self.target_preview = QTextEdit()
        self.target_preview.setReadOnly(True)
        self.target_preview.setPlaceholderText("Input targets will be displayed here")
        ...
        """)
        left_layout.addWidget(self.target_preview)
    ...
    def update_input(self, text):
        self.target_preview.setPlainText(text)
    ...
    def convert_targets(self):
        input_targets = self.target_preview.toPlainText().strip().split('\n')
